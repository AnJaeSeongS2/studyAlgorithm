        ...
        try {
            for (String music : musicinfos) {
                ...
                if (orderedMusicInfos.containsKey(minute)) {
                    orderedMusicInfos.get(minute).add(new AbstractMap.SimpleEntry<>(elem[2], String.valueOf(passedMusic)));
                } else {
                    List<AbstractMap.SimpleEntry<String, String>> newInstance = new LinkedList<>();
                    newInstance.add(new AbstractMap.SimpleEntry<>(elem[2], String.valueOf(passedMusic)));
